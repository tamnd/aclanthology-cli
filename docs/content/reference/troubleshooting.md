...
Most of these come down to network reality or how aclanthology serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

aclanthology rate-limits like any public site. acl already paces
...
Where a surface is gated, acl reads a cookie or token you supply
...
`acl`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what acl actually did
